        ...
        "undefined" != typeof window &&
          ...
          (t.prototype.getBuffer = function () {
            if ((this.flush(), e.useBlobBuilder)) {
              for (
                var t = new r(), i = 0, u = this._parts.length;
                i < u;
                i++
              )
        ...
        (module.exports = i),
          (r.prototype.unpack = function () {
            ...
            switch (e) {
              ...
              case 216:
                return (
                  (t = this.unpack_uint16()), this.unpack_string(t)
                );
              case 217:
                return (
                  (t = this.unpack_uint32()), this.unpack_string(t)
                );
              case 218:
              ...
              case 220:
                return (
                  (t = this.unpack_uint16()), this.unpack_array(t)
                );
              case 221:
                return (
                  (t = this.unpack_uint32()), this.unpack_array(t)
                );
              case 222:
          ...
          (r.prototype.read = function (t) {
            var e = this.index;
            if (e + t <= this.length)
              return this.dataView.subarray(e, e + t);
            throw new Error(
              "BinaryPackFailure: read index out of range"
            );
          }),
      ...
      function (require, module, exports) {
        ...
        function s(e) {
          return "boolean" != typeof e
            ? new Error(
                "Argument type: " + t(e) + ". Please use a boolean."
              )
            : ((n = e),
              e
        ...
        function i(r) {
          ...
          if (t.mediaDevices) {
            ...
            if (
              ...
              var u = t.mediaDevices.getUserMedia.bind(
                t.mediaDevices
              );
      ...
      function (require, module, exports) {
        ...
        function c(t) {
          if (
            ...
            var r =
              t.RTCPeerConnection.prototype.setRemoteDescription;
            t.RTCPeerConnection.prototype.setRemoteDescription =
              function () {
                var e = this;
                return (
                  this._ontrackpoly ||
                    ((this._ontrackpoly = function (r) {
                      r.stream.addEventListener(
                        "addtrack",
                        function (n) {
                          var i;
                          i = t.RTCPeerConnection.prototype
                            .getReceivers
                            ? e.getReceivers().find(function (e) {
                                return (
                                  e.track && e.track.id === n.track.id
                                );
                              })
                            : { track: n.track };
          ...
          if (
            ...
            if (!e.RTCPeerConnection.prototype.getSenders) {
              ...
              e.RTCPeerConnection.prototype.addTrack = function (
                ...
                return (
                  i || ((i = t(this, e)), this._senders.push(i)), i
                );
              };
        ...
        function h(t) {
          if (
            ...
            if (!("getStats" in t.RTCRtpSender.prototype)) {
              ...
              r &&
                (t.RTCPeerConnection.prototype.getSenders =
                  function () {
                    var e = this,
                      t = r.apply(this, []);
                    return (
              ...
              n &&
                (t.RTCPeerConnection.prototype.addTrack =
                  function () {
            ...
            if (!("getStats" in t.RTCRtpReceiver.prototype)) {
              ...
              i &&
                (t.RTCPeerConnection.prototype.getReceivers =
                  function () {
                    var e = this,
                      t = i.apply(this, []);
                    return (
              ...
              e &&
                Object.keys(this._shimmedLocalStreams).forEach(
                  function (r) {
                    ...
                    -1 !== n &&
                      t._shimmedLocalStreams[r].splice(n, 1),
        ...
        function m(t) {
          if (t.RTCPeerConnection) {
            ...
            t.RTCPeerConnection.prototype.getLocalStreams =
              function () {
                var e = this,
                  t = n.apply(this);
                return (
            ...
            (t.RTCPeerConnection.prototype.removeStream = function (
              e
            ) {
              (this._streams = this._streams || {}),
                (this._reverseStreams = this._reverseStreams || {}),
            ...
            t.RTCPeerConnection.prototype.setLocalDescription =
              function () {
            ...
            Object.defineProperty(
              ...
              (t.RTCPeerConnection.prototype.removeTrack = function (
                e
              ) {
                var t,
                  r = this;
      ...
      function (require, module, exports) {
        ...
        (r.localCName = r.generateIdentifier()),
          ...
          (r.writeCandidate = function (r) {
            ...
            return (
              ...
              (r.usernameFragment || r.ufrag) &&
                (e.push("ufrag"),
                e.push(r.usernameFragment || r.ufrag)),
              "candidate:" + e.join(" ")
            );
          }),
          ...
          (r.parseRtcpParameters = function (e) {
            ...
            (t.reducedSize = a.length > 0),
              (t.compound = 0 === a.length);
          ...
          (r.writeSctpDescription = function (r, e) {
            ...
            return (
              ...
              void 0 !== e.maxMessageSize &&
                t.push(
                  "a=max-message-size:" + e.maxMessageSize + "\r\n"
                ),
              t.join("")
            );
          }),
          ...
          (r.writeMediaSection = function (e, t, n, a) {
            ...
            if (
              ...
              var i =
                "msid:" + a.id + " " + e.rtpSender.track.id + "\r\n";
              (s += "a=" + i),
                (s +=
                  "a=ssrc:" +
    ...
    NJ2u: [
      function (require, module, exports) {
        ...
        function r(t, r, n, a, i) {
          ...
          if (
            ((s += e.writeIceParameters(
              t.iceGatherer.getLocalParameters()
            )),
            ...
            var o =
              t.rtpSender._initialTrackId || t.rtpSender.track.id;
          ...
          var r = {
            ...
            a = function (e, t, r, a) {
              ...
              return (
                i &&
                s &&
                i.name.toLowerCase() === s.name.toLowerCase()
              );
            };
          return (
              ...
              for (var i = 0; i < t.codecs.length; i++) {
                ...
                if (
                  ...
                  ((s = JSON.parse(JSON.stringify(s))).numChannels =
                    Math.min(n.numChannels, s.numChannels)),
                    r.codecs.push(s),
                    (s.rtcpFeedback = s.rtcpFeedback.filter(function (
                      e
                    ) {
          ...
          Object.defineProperty(f.prototype, "localDescription", {
            ...
            (f.prototype.addTrack = function (e, t) {
              ...
              return (
                ...
                (r.track = e),
                (r.stream = t),
                (r.rtpSender = new c.RTCRtpSender(
                  e,
                  r.dtlsTransport
                )),
                r.rtpSender
            ...
            (f.prototype._createIceGatherer = function (e, t) {
              ...
              return (
                ...
                (this.transceivers[e].bufferCandidates = function (
                  t
                ) {
                  var a =
                    !t.candidate ||
                    0 === Object.keys(t.candidate).length;
                  (n.state = a ? "completed" : "gathering"),
                    null !==
                      r.transceivers[e].bufferedCandidateEvents &&
                      r.transceivers[e].bufferedCandidateEvents.push(
                        t
                      );
                }),
                n.addEventListener(
                        ...
                        (s.candidate = Object.assign(
                          ...
                          (s.candidate.toJSON = function () {
                            return {
                              ...
                              sdpMLineIndex:
                                s.candidate.sdpMLineIndex,
                              usernameFragment:
                                s.candidate.usernameFragment,
                            };
                          });
                      }
                      var p = e.getMediaSections(
            ...
            (f.prototype.setRemoteDescription = function (t) {
              ...
              return (
                (r.canTrickleIceCandidates =
                  !!g &&
                  g.substr(14).split(" ").indexOf("trickle") >= 0),
                u.forEach(function (i, o) {
                  ...
                  if (
                    ...
                    !g &&
                      ...
                      (r.transceivers[o] = r._createTransceiver(
                        u,
                        !0
                      ));
                    var I,
                    ...
                    g ||
                      ...
                      ((L = e.getDtlsParameters(i, v)).role =
                        "client")),
                      (b = e.parseRtpEncodingParameters(i));
                    var O = e.parseRtcpParameters(i),
                      G =
                        e.matchPrefix(i, "a=end-of-candidates", v)
                          .length > 0,
                      j = e
                    ...
                    if (
                      ...
                      if ("answer" === t.type && !g) {
                        (P = (C = r.transceivers[o]).iceGatherer),
                          ...
                          (r.transceivers[o].recvEncodingParameters =
                            b),
                      ...
                      ((C =
                        r.transceivers[o] ||
                        r._createTransceiver(u)).mid = E),
                        C.iceGatherer ||
                          (C.iceGatherer = r._createIceGatherer(
                            o,
                            m
                          )),
                        j.length &&
                      ...
                      if ("sendrecv" === S || "sendonly" === S) {
                        if (
                          ...
                          (D = _.track),
                            ...
                            N &&
                              (p(D, N),
                              C.associatedRemoteMediaStreams.push(N)),
                            f.push([D, _, N]);
                      } else
                        C.rtpReceiver &&
                          C.rtpReceiver.track &&
                          (C.associatedRemoteMediaStreams.forEach(
                            function (e) {
                              var t,
                                r,
                                n = e.getTracks().find(function (e) {
                                  return (
                                    e.id === C.rtpReceiver.track.id
                                  );
                                });
                              n &&
                                ((t = n),
                  ...
                  r &&
                    ...
                    r.transceivers.forEach(function (e) {
                      e.iceTransport &&
                        ...
                        e.iceTransport.getRemoteCandidates().length >
                          0 &&
                        (console.warn(
            ...
            (f.prototype.createOffer = function () {
              ...
              t.transceivers.forEach(function (r, n) {
                ...
                (r.mid = s),
                  r.iceGatherer ||
                    (r.iceGatherer = t._createIceGatherer(
                      n,
                      t.usingBundle
                    ));
                  ...
                  o.codecs.forEach(function (e) {
                    "H264" === e.name &&
                      ...
                      r.remoteCapabilities &&
                        ...
                        r.remoteCapabilities.codecs.forEach(function (
                          t
                        ) {
                          e.name.toLowerCase() ===
                            t.name.toLowerCase() &&
                ...
                a &&
                  ...
                  r.wantReceive &&
                    (r.rtpReceiver = new c.RTCRtpReceiver(
                      r.dtlsTransport,
                      i
                    )),
            ...
            (f.prototype.createAnswer = function () {
              ...
              var i = e.getMediaSections(
                t._remoteDescription.sdp
              ).length;
      ...
      function (require, module, exports) {
        ...
        function d(e) {
          if ("object" === a(e) && e.RTCPeerConnection) {
            ...
            t &&
              (e.RTCPeerConnection.prototype.addTransceiver =
                function () {
              ...
              for (var n = [], i = 0; i < t.iceServers.length; i++) {
                ...
                !a.hasOwnProperty("urls") && a.hasOwnProperty("url")
                  ? (e.deprecated(
                    ...
                    ((a = JSON.parse(JSON.stringify(a))).urls =
                      a.url),
                    delete a.url,
                    n.push(a))
      ...
      function (require, module, exports) {
        ...
        function a(n) {
          if (
            ...
            !(
              n.RTCIceCandidate &&
              "foundation" in n.RTCIceCandidate.prototype
            )
          ) {
        ...
        function c(n) {
          if (n.RTCPeerConnection) {
            ...
            var r =
              n.RTCPeerConnection.prototype.setRemoteDescription;
            n.RTCPeerConnection.prototype.setRemoteDescription =
              function () {
                if (
                  ((this._sctp = null),
                  "chrome" === o.browser && o.version >= 76)
                ) {
        ...
        exports.util = new ((function () {
          ...
          return (
            ...
            (r.prototype.validateId = function (r) {
              return (
                !r || /^[A-Za-z0-9]+(?:[ _-][A-Za-z0-9]+)*$/.test(r)
              );
            }),
            ...
            (r.prototype.binaryStringToArrayBuffer = function (r) {
              for (
                var t = new Uint8Array(r.length), e = 0;
                e < r.length;
                e++
              )
      ...
      function (require, module, exports) {
        ...
        Object.create &&
          ...
          (i.prototype.listeners = function (e) {
            ...
            if (r.fn) return [r.fn];
            for (
              var o = 0, s = r.length, i = new Array(s);
              o < s;
              o++
            )
              i[o] = r[o].fn;
          ...
          (i.prototype.emit = function (e, n, r, o, s, i) {
            ...
            if (a.fn) {
              switch (
                (a.once && this.removeListener(e, a.fn, void 0, !0),
                l)
              ) {
                case 1:
              ...
              for (u = 0; u < h; u++)
                switch (
                  (a[u].once &&
                    this.removeListener(e, a[u].fn, void 0, !0),
                  l)
                ) {
                  case 1:
          ...
          return (
            ...
            (r.prototype.log = function () {
              ...
              this._logLevel >= o.All &&
                this._print.apply(this, e([o.All], r));
            }),
        ...
        var i = require("./util"),
          ...
          a = (function () {
            ...
            return (
              ...
              (o.prototype.cleanup = function () {
                ...
                if (e) {
                  ...
                  if (
                    ...
                    o &&
                      (t =
                        !!o.readyState && "closed" !== o.readyState);
                  }
                  (n || t) && e.close();
                }
              }),
                      ...
                      case 2:
                        (a = t.sent()),
                          ...
                          this.connection.options.sdpTransform &&
                            "function" ==
                              typeof this.connection.options
                                .sdpTransform &&
                            (a.sdp =
                              this.connection.options.sdpTransform(
                                a.sdp
              ...
              (o.prototype._addStreamToMediaConnection = function (
                e,
                n
              ) {
                r.default.log(
          ...
          c = (function (r) {
            function l(e, t, o) {
              ...
              return (
                ...
                (i.connectionId =
                  i.options.connectionId ||
                  l.ID_PREFIX + n.util.randomToken()),
            ...
            return (
              ...
              (l.prototype.addStream = function (e) {
                i.default.log("Receiving stream", e),
                  ...
                  r.prototype.emit.call(
                    this,
                    s.ConnectionEventType.Stream,
                    e
                  );
              }),
              (l.prototype.handleMessage = function (e) {
                ...
                switch (e.type) {
                  case s.ServerMessageType.Answer:
                    this._negotiator.handleSDP(t, o.sdp),
                      (this._open = !0);
                    break;
              ...
              (l.prototype.answer = function (e, r) {
                ...
                if ((void 0 === r && (r = {}), this._localStream))
                  ...
                  var s = this.provider._getMessages(
                    this.connectionId
                  );
                  try {
                    for (
          ...
          n = (function (t) {
            ...
            return (
              ...
              (r.prototype.enque = function (e) {
                this.queue.push(e),
                  this.processing || this.doNextTask();
              }),
            ...
            function s(e, t, l) {
              ...
              return (
                ...
                (f.connectionId =
                  ...
                  s.ID_PREFIX + i.util.randomToken()),
                (f.label = f.options.label || f.connectionId),
                (f.serialization =
                  f.options.serialization ||
                  a.SerializationType.Binary),
            ...
            return (
              ...
              (s.prototype._configureDataChannel = function () {
                ...
                (i.util.supports.binaryBlob &&
                  !i.util.supports.reliable) ||
                  (this.dataChannel.binaryType = "arraybuffer"),
                  (this.dataChannel.onopen = function () {
                    o.default.log(
                      "DC#" +
                        e.connectionId +
                        " dc connection success"
                    ),
                      (e._open = !0),
              ...
              (s.prototype._handleDataMessage = function (e) {
                ...
                if (
                  ...
                  this.serialization ===
                    a.SerializationType.BinaryUTF8
                ) {
                  if (r === Blob)
                    return void i.util.blobToArrayBuffer(
                      o,
                      function (e) {
                    ...
                    switch (e.label) {
                      ...
                      case 3:
                        throw (
                          ...
                          new Error(
                            "Could not get an ID from the server." + i
                          ))
                        );
                      case 4:
                        return [2];
          ...
          f = (function (o) {
            ...
            return (
              ...
              (i.prototype._storeMessage = function (e, t) {
                this._lostMessages.has(e) ||
                  this._lostMessages.set(e, []),
              ...
              (i.prototype._addConnection = function (e, t) {
                a.default.log(
                  ...
                  this._connections.has(e) ||
                    this._connections.set(e, []),
              ...
              (i.prototype.emitError = function (e, t) {
                ...
                a.default.error("Error:", t),
                  ((n =
                    "string" == typeof t ? new Error(t) : t).type =
                    e),
